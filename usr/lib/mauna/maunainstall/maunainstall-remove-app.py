...
from maunacommon.installer.misc import check_ml

# i18n
gettext.install("maunainstall", "/usr/share/mauna/locale")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2 or not os.path.exists(sys.argv[1]) or not sys.argv[1].endswith(".desktop"):
        print("maunainstall-remove-app: Single argument required, the full path of a desktop file.")
        sys.exit(1)
