...
FALLBACK_PACKAGE_ICON_PATH = "/usr/share/mauna/maunainstall/data/fallback-package-icon.svg"
...
threadpool = ThreadPoolExecutor(max_workers=MAX_THREADS, thread_name_prefix="maunainstall-images")
icon_surface_cache = {}
